    ...
    <div className="space-y-8 max-w-5xl">
      ...
      <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-6">
        <div className="flex items-center gap-3 border-b border-slate-50 pb-4">
          ...
          <h3 className="text-lg font-black text-slate-900"><span>폐차/수출 페이지 관리</span></h3>
        </div>
        <div className="grid grid-cols-1 gap-6">
          <div className="space-y-2">
            <label className="text-xs font-black text-slate-400 uppercase tracking-widest"><span>히어로 타이틀</span></label>
            <input 
              type="text" 
              value={formData.scrapHeroTitle || ""}
              onChange={(e) => handleLocalChange('scrapHeroTitle', e.target.value)}
              onBlur={(e) => handleBlur('scrapHeroTitle', e.target.value)}
              className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-xl py-3 px-4 outline-none transition-all font-bold"
              translate="no"
            />
          </div>
          <div className="space-y-2">
            ...
            <input 
              type="text" 
              value={formData.scrapHeroSubtitle || ""}
              onChange={(e) => handleLocalChange('scrapHeroSubtitle', e.target.value)}
              onBlur={(e) => handleBlur('scrapHeroSubtitle', e.target.value)}
              className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-xl py-3 px-4 outline-none transition-all font-bold"
              translate="no"
            />
          </div>
          <div className="space-y-2">
            <label className="text-xs font-black text-slate-400 uppercase tracking-widest"><span>신청폼 타이틀</span></label>
            <input 
              type="text" 
              value={formData.scrapFormTitle || ""}
              onChange={(e) => handleLocalChange('scrapFormTitle', e.target.value)}
              onBlur={(e) => handleBlur('scrapFormTitle', e.target.value)}
              className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-xl py-3 px-4 outline-none transition-all font-bold"
              translate="no"
            />
          </div>
          <div className="space-y-2">
            ...
            <input 
              type="text" 
              value={formData.scrapProcessTitle || ""}
              onChange={(e) => handleLocalChange('scrapProcessTitle', e.target.value)}
              onBlur={(e) => handleBlur('scrapProcessTitle', e.target.value)}
              className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-xl py-3 px-4 outline-none transition-all font-bold"
              translate="no"
            />
          </div>
          <div className="space-y-2">
            <label className="text-xs font-black text-slate-400 uppercase tracking-widest"><span>가이드 섹션 타이틀</span></label>
            <input 
              type="text" 
              value={formData.scrapGuideTitle || ""}
              onChange={(e) => handleLocalChange('scrapGuideTitle', e.target.value)}
              onBlur={(e) => handleBlur('scrapGuideTitle', e.target.value)}
              className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-xl py-3 px-4 outline-none transition-all font-bold"
              translate="no"
            />
          </div>
          <div className="space-y-2">
            <label className="text-xs font-black text-slate-400 uppercase tracking-widest"><span>단가안내 섹션 타이틀</span></label>
            <input 
              type="text" 
              value={formData.scrapPriceTitle || ""}
              onChange={(e) => handleLocalChange('scrapPriceTitle', e.target.value)}
              onBlur={(e) => handleBlur('scrapPriceTitle', e.target.value)}
              className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-xl py-3 px-4 outline-none transition-all font-bold"
              translate="no"
            />
          </div>
          <div className="space-y-2">
            ...
            <input 
              type="text" 
              value={formData.scrapBannerTitle || ""}
              onChange={(e) => handleLocalChange('scrapBannerTitle', e.target.value)}
              onBlur={(e) => handleBlur('scrapBannerTitle', e.target.value)}
              className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-xl py-3 px-4 outline-none transition-all font-bold"
              translate="no"
            />
          </div>
          <div className="space-y-2">
            ...
            <input 
              type="text" 
              value={formData.scrapBannerSubtitle || ""}
              onChange={(e) => handleLocalChange('scrapBannerSubtitle', e.target.value)}
              onBlur={(e) => handleBlur('scrapBannerSubtitle', e.target.value)}
              className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-xl py-3 px-4 outline-none transition-all font-bold"
              translate="no"
            />
          </div>
